// *******************************************************************************************************
// **                                                                                                   **
// **   24LC32A.v - Microchip 24LC32A 32K-BIT I2C SERIAL EEPROM (VCC = +2.5V TO +5.5V)                  **
// **                                                                                                   **
// *******************************************************************************************************
// **                                                                                                   **
...
module M24LC32A (A0, A1, A2, WP, SDA, SCL, RESET);
...
// *******************************************************************************************************
   ...
   reg  [11:00]         StartAddress;                   // memory access starting address
   ...
   reg  [11:00]         RdPointer;                      // read address pointer

   reg                  WriteActive;                    // memory write cycle active

   reg  [07:00]         MemoryBlock [0:4095];           // EEPROM data memory array
...
// -------------------------------------------------------------------------------------------------------
   ...
   always @(negedge SCL) begin
      if (CTRL_Rcvd & (BitCounter == 8)) begin
         if (RdWrBit == 0) begin
            StartAddress[11:08] <= ShiftRegister[03:00];
            RdPointer[11:08]    <= ShiftRegister[03:00];
...
// -------------------------------------------------------------------------------------------------------
   ...
   always @(negedge WriteActive) begin
      for (LoopIndex = 0; LoopIndex < WrCounter; LoopIndex = LoopIndex + 1) begin
         ...
         MemoryBlock[{StartAddress[11:05],PageAddress[04:00]}] = WrDataByte[LoopIndex[04:00]];
      end
   end
...
// -------------------------------------------------------------------------------------------------------
   ...
   assign RdDataByte = MemoryBlock[RdPointer[11:00]];
